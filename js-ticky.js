...
var fn = outer();
fn();  // 10  - closure's environment concept
// Note : variable me save he to inner function call hoga and return 10 karega, bina variable ke sirf inner function return karega
...
// You create a new variable newObj and assign it the reference to obj. This means newObj and obj now refer to the same object in memory. So, any change to newObj will also affect obj because they point to the same underlying object.
  ...
  const newObj = obj;
  newObj.increment();
  console.log(newObj.increment()); // 11 // in function without return it will be undefined
...
console.log(+true); // 1
console.log(!'Lydia'); // false - logical not operation return boolean value true and false
...
let a = 3;
let b = new Number(3); // here type is object and b output is : Number{3}
let c = 3;
